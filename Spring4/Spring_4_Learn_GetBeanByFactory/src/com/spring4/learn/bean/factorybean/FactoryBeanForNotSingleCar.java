 ...
 * 
 * @Package: com.spring4.learn.bean.factorybean
 * @ClassName: FactoryBeanForNotSingleCar.java
 *
 ...
 * @Company:
 * @Author: ZCX  
 * @CreateDate: 2017年2月10日 下午3:09:35
 * @UpdateDate: 2017年2月10日 下午3:09:35
 * @Version: V1.0
 */
public class FactoryBeanForNotSingleCar implements FactoryBean<CarForFactoryBean> {
...
private String brand;
	...
	public CarForFactoryBean getObject() throws Exception {
		...
		//return null;
		System.out.println("FactoryBeanForNotSingleCar.getObject ... ... ");;
