 ...
 * 
 * @Package: com.spring4.learn.bean.cycle
 * @ClassName: OtherBeanPostProcessor.java
 *
 ...
 * @Company:
 * @Author: ZCX  
 * @CreateDate: 2017年2月9日 下午3:32:16
 * @UpdateDate: 2017年2月9日 下午3:32:16
 * @Version: V1.0
 */
public class OtherBeanPostProcessor implements BeanPostProcessor {
	...
	public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
		...
		System.out.println("OtherBeanPostProcessor.postProcessAfterInitialization... ... " + beanName + ", " + bean);
		return bean;
	}
	...
	public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
		// TODO Auto-generated method stub
		System.out.println("OtherBeanPostProcessor.postProcessBeforeInitialization... ... " + beanName + ", " + bean);
		return bean;
	}
