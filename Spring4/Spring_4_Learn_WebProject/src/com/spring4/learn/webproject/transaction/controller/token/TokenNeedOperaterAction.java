...
@Controller
@RequestMapping(value = "/token/operater")
public class TokenNeedOperaterAction {
	
	@Autowired
	private TokenResponseFormatService tokenResponseFormatService;
	
	@RequestMapping(value = "/checkTest", method = RequestMethod.POST)
	public void checkTest(HttpServletRequest request, HttpServletResponse response, @RequestBody String paramJsonInfoStr) throws IOException {
